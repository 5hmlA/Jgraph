 ...
 *
 */
public class MultiChart extends SuperChart {
...
//    }
    ...
    public MultiChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }


    public MultiChart(Context context, AttributeSet attrs, int defStyleAttr) {
