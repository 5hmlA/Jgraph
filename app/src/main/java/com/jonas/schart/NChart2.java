...
public class NChart2 extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public NChart2(Context context) {
        super(context);
        init(context);
    }

    public NChart2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NChart2(Context context, AttributeSet attrs, int defStyleAttr) {
